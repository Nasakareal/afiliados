...
@section('title', 'Editar referente seccional')

@section('content_header')
    <h1 class="text-center w-100">Editar referente seccional</h1>
@endsection
...
<div class="container-xl">
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <form
                action="{{ route('referentes_seccionales.update', $referente) }}"
                method="POST"
                autocomplete="off"
            >
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input
                            type="hidden"
                            name="cve_mun"
                            value="{{ old('cve_mun', $referente->cve_mun) }}"
                        >

                        <div class="form-text">
                            CVE municipal:
                            {{ str_pad((string)$referente->cve_mun, 3, '0', STR_PAD_LEFT) }}
                        </div>
                        ...
                        >
                            ...
                            @foreach($secciones as $seccion)
                                ...
                                <option
                                    ...
                                    data-distrito-local="{{ $seccion->distrito_local }}"
                                    data-distrito-federal="{{ $seccion->distrito_federal }}"
                                    {{ (string)old('seccion', $referente->seccion) === (string)$seccion->seccion ? 'selected' : '' }}
                                >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            type="text"
                            id="txtDistritoLocal"
                            value="{{ old('distrito_local', $referente->distrito_local) }}"
                            class="form-control"
                            readonly
                        >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="{{ old('distrito_federal', $referente->distrito_federal) }}"
                            class="form-control"
                            readonly
                        >
