...
@section('title', 'Nuevo referente municipal')

@section('content_header')
    <h1 class="text-center w-100">Nuevo referente municipal</h1>
@endsection
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-header">
            <h3 class="card-title mb-0">
                Captura de referente municipal
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <form
                action="{{ route('referentes_municipales.store') }}"
                method="POST"
                autocomplete="off"
            >
                    ...
                    <div class="col-md-6">
                        ...
                        >
                            ...
                            @foreach($municipios as $municipio)
                                ...
                                <option
                                    value="{{ str_pad((string)$municipio->cve_mun, 3, '0', STR_PAD_LEFT) }}"
                                    {{ old('cve_mun') == str_pad((string)$municipio->cve_mun, 3, '0', STR_PAD_LEFT) ? 'selected' : '' }}
                                >
                                    {{ $municipio->municipio }}
                                    — CVE {{ str_pad((string)$municipio->cve_mun, 3, '0', STR_PAD_LEFT) }}
                                </option>
