...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .header { height:38px; margin-bottom:4px; color:#fff; background:#7d1727; border-radius:3px; }
    ...
    .label { display:block; height:7px; margin:0 0 1px; overflow:hidden; color:#555; font-size:5.5px; font-weight:bold; line-height:7px; text-transform:uppercase; white-space:nowrap; }
    .value { display:block; width:100%; height:11px; overflow:hidden; white-space:nowrap; font-size:7.5px; font-weight:bold; line-height:11px; }
    .address-value { height:16px; font-size:6.5px; line-height:8px; white-space:normal; word-wrap:break-word; }
    .person { position:relative; height:60px; margin-bottom:4px; padding-left:28px; overflow:hidden; page-break-inside:avoid; }
    .number { position:absolute; top:0; left:0; width:24px; height:60px; padding-top:20px; color:#fff; background:#8b1e2d; border:1px solid #6f1220; border-radius:3px; text-align:center; font-size:13px; font-weight:bold; line-height:18px; }
    .row { width:100%; border-collapse:collapse; table-layout:fixed; }
    .row td { height:29px; padding:2px 5px 0; overflow:hidden; vertical-align:top; border:1px solid #2f2f2f; }
    ...
    .address { width:69%; }
    .section { width:12%; }
    .flags { width:19%; padding:6px 4px 0 !important; overflow:hidden; white-space:nowrap; }
    .flag { display:inline-block; margin-right:4px; font-size:7.5px; font-weight:bold; }
    .dot { display:inline-block; width:7px; height:7px; margin-right:2px; vertical-align:-1px; border:1px solid #111; border-radius:50%; }
    .dot.checked { background:#111; }
    .mov-number { display:inline-block; width:46px; height:9px; margin-left:1px; padding:0 2px 1px; overflow:hidden; border-bottom:1px solid #111; line-height:8px; vertical-align:-1px; }
    .footer { height:9px; margin-top:2px; overflow:hidden; color:#555; text-align:right; font-size:5.5px; line-height:8px; white-space:nowrap; }
  </style>
</head>
<body>
@php
  ...
  <section class="sheet">
    ...
    @for($slot = 0; $slot < 10; $slot++)
      ...
      <div class="person">
        ...
        <table class="row"><tr>
          <td class="address"><span class="label">Calle / N.º int-ext / colonia / C.P. / localidad / municipio</span><span class="value address-value">{{ $direccion }}</span></td>
